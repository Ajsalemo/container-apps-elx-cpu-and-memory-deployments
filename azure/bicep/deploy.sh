# Run the following command - relative to deploy.bicep
...
az deployment group create --resource-group "ansalemo-rg" --template-file deploy.bicep --parameters location="eastus"